...
public class CommentByVideo_Table implements TableMetadata<CommentByVideo> {
  ...
  public static final CommentByVideo_Table comments_by_video = new CommentByVideo_Table();

  public static final String KEYSPACE_NAME = "killrvideo";

  public static final String TABLE_NAME = "comments_by_video";

  private CommentByVideo_Table() {
  }
  ...
  public void setGeneratedValues(CommentByVideo entity) {
    if (entity != null) {
    }
  }

  public void setCreationDate(CommentByVideo entity, Instant creationDate) {
    if (entity != null) {
    }
  }

  public void setLastUpdatedDate(CommentByVideo entity, Instant lastUpdatedDate) {
    if (entity != null) {
    }
  }

  public Map<String, Object> serialize(CommentByVideo entity) {
  ...
  public CommentByVideo deserialize(Row row) {
    if (row == null) return null;
    CommentByVideo entity = new CommentByVideo();
